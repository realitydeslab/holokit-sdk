...
#pragma mark - Input Lifecycle Methods
    ...
    UnitySubsystemErrorCode UpdateDeviceState(
        ...
        switch (device_id) {
            case kDeviceIdHoloKitHme: {
                simd_float4x4 camera_transform = ar_session_handler.session.currentFrame.camera.transform;
            ...
            case kDeviceIdHoloKitHandLeft: {
                ...
                if(ar_session_handler == nullptr) {
                    HOLOKIT_INPUT_XR_TRACE_LOG(trace_, "%f ar_session_handler is nullptr!", GetCurrentTime());
                }
                
                if([ar_session_handler.leftHandLandmarkPositions count] != 21){
                ...
                // wrist
                UnityXRVector3 position0 = { ar_session_handler.leftHandLandmarkPositions[0].x, ar_session_handler.leftHandLandmarkPositions[0].y, ar_session_handler.leftHandLandmarkPositions[0].z };
                ...
                // thumb start
                UnityXRVector3 position1 = { ar_session_handler.leftHandLandmarkPositions[1].x, ar_session_handler.leftHandLandmarkPositions[1].y, ar_session_handler.leftHandLandmarkPositions[1].z };
                input_->DeviceState_SetBoneValue(state, 1, UnityXRBone {.parentBoneIndex = 0, .position = position1, .rotation = {0, 0, 0, 1}});
                // thumb 1
                UnityXRVector3 position2 = { ar_session_handler.leftHandLandmarkPositions[2].x, ar_session_handler.leftHandLandmarkPositions[2].y, ar_session_handler.leftHandLandmarkPositions[2].z };
                input_->DeviceState_SetBoneValue(state, 2, UnityXRBone {.parentBoneIndex = 1, .position = position2, .rotation = {0, 0, 0, 1}});
                // thumb 2
                UnityXRVector3 position3 = { ar_session_handler.leftHandLandmarkPositions[3].x, ar_session_handler.leftHandLandmarkPositions[3].y, ar_session_handler.leftHandLandmarkPositions[3].z };
                input_->DeviceState_SetBoneValue(state, 3, UnityXRBone {.parentBoneIndex = 2, .position = position3, .rotation = {0, 0, 0, 1}});
                // thumb end
                UnityXRVector3 position4 = { ar_session_handler.leftHandLandmarkPositions[4].x, ar_session_handler.leftHandLandmarkPositions[4].y, ar_session_handler.leftHandLandmarkPositions[4].z };
                input_->DeviceState_SetBoneValue(state, 4, UnityXRBone {.parentBoneIndex = 3, .position = position4, .rotation = {0, 0, 0, 1}});
                // index start
                UnityXRVector3 position5 = { ar_session_handler.leftHandLandmarkPositions[5].x, ar_session_handler.leftHandLandmarkPositions[5].y, ar_session_handler.leftHandLandmarkPositions[5].z };
                input_->DeviceState_SetBoneValue(state, 5, UnityXRBone {.parentBoneIndex = 0, .position = position5, .rotation = {0, 0, 0, 1}});
                // index 1
                UnityXRVector3 position6 = { ar_session_handler.leftHandLandmarkPositions[6].x, ar_session_handler.leftHandLandmarkPositions[6].y, ar_session_handler.leftHandLandmarkPositions[6].z };
                input_->DeviceState_SetBoneValue(state, 6, UnityXRBone {.parentBoneIndex = 5, .position = position6, .rotation = {0, 0, 0, 1}});
                // index 2
                UnityXRVector3 position7 = { ar_session_handler.leftHandLandmarkPositions[7].x, ar_session_handler.leftHandLandmarkPositions[7].y, ar_session_handler.leftHandLandmarkPositions[7].z };
                input_->DeviceState_SetBoneValue(state, 7, UnityXRBone {.parentBoneIndex = 6, .position = position7, .rotation = {0, 0, 0, 1}});
                // index end
                UnityXRVector3 position8 = { ar_session_handler.leftHandLandmarkPositions[8].x, ar_session_handler.leftHandLandmarkPositions[8].y, ar_session_handler.leftHandLandmarkPositions[8].z };
                input_->DeviceState_SetBoneValue(state, 8, UnityXRBone {.parentBoneIndex = 7, .position = position8, .rotation = {0, 0, 0, 1}});
                // middle start
                UnityXRVector3 position9 = { ar_session_handler.leftHandLandmarkPositions[9].x, ar_session_handler.leftHandLandmarkPositions[9].y, ar_session_handler.leftHandLandmarkPositions[9].z };
                input_->DeviceState_SetBoneValue(state, 9, UnityXRBone {.parentBoneIndex = 0, .position = position9, .rotation = {0, 0, 0, 1}});
                // middle 1
                UnityXRVector3 position10 = { ar_session_handler.leftHandLandmarkPositions[10].x, ar_session_handler.leftHandLandmarkPositions[10].y, ar_session_handler.leftHandLandmarkPositions[10].z };
                input_->DeviceState_SetBoneValue(state, 10, UnityXRBone {.parentBoneIndex = 9, .position = position10, .rotation = {0, 0, 0, 1}});
                // middle 2
                UnityXRVector3 position11 = { ar_session_handler.leftHandLandmarkPositions[11].x, ar_session_handler.leftHandLandmarkPositions[11].y, ar_session_handler.leftHandLandmarkPositions[11].z };
                input_->DeviceState_SetBoneValue(state, 11, UnityXRBone {.parentBoneIndex = 10, .position = position11, .rotation = {0, 0, 0, 1}});
                // middle end
                UnityXRVector3 position12 = { ar_session_handler.leftHandLandmarkPositions[12].x, ar_session_handler.leftHandLandmarkPositions[12].y, ar_session_handler.leftHandLandmarkPositions[12].z };
                input_->DeviceState_SetBoneValue(state, 12, UnityXRBone {.parentBoneIndex = 11, .position = position12, .rotation = {0, 0, 0, 1}});
                // ring start
                UnityXRVector3 position13 = { ar_session_handler.leftHandLandmarkPositions[13].x, ar_session_handler.leftHandLandmarkPositions[13].y, ar_session_handler.leftHandLandmarkPositions[13].z };
                input_->DeviceState_SetBoneValue(state, 13, UnityXRBone {.parentBoneIndex = 0, .position = position13, .rotation = {0, 0, 0, 1}});
                // ring 1
                UnityXRVector3 position14 = { ar_session_handler.leftHandLandmarkPositions[14].x, ar_session_handler.leftHandLandmarkPositions[14].y, ar_session_handler.leftHandLandmarkPositions[14].z };
                input_->DeviceState_SetBoneValue(state, 14, UnityXRBone {.parentBoneIndex = 13, .position = position14, .rotation = {0, 0, 0, 1}});
                // ring 2
                UnityXRVector3 position15 = { ar_session_handler.leftHandLandmarkPositions[15].x, ar_session_handler.leftHandLandmarkPositions[15].y, ar_session_handler.leftHandLandmarkPositions[15].z };
                input_->DeviceState_SetBoneValue(state, 15, UnityXRBone {.parentBoneIndex = 14, .position = position15, .rotation = {0, 0, 0, 1}});
                // ring end
                UnityXRVector3 position16 = { ar_session_handler.leftHandLandmarkPositions[16].x, ar_session_handler.leftHandLandmarkPositions[16].y, ar_session_handler.leftHandLandmarkPositions[16].z };
                input_->DeviceState_SetBoneValue(state, 16, UnityXRBone {.parentBoneIndex = 15, .position = position16, .rotation = {0, 0, 0, 1}});
                // pinky start
                UnityXRVector3 position17 = { ar_session_handler.leftHandLandmarkPositions[17].x, ar_session_handler.leftHandLandmarkPositions[17].y, ar_session_handler.leftHandLandmarkPositions[17].z };
                input_->DeviceState_SetBoneValue(state, 17, UnityXRBone {.parentBoneIndex = 0, .position = position17, .rotation = {0, 0, 0, 1}});
                // pinky 1
                UnityXRVector3 position18 = { ar_session_handler.leftHandLandmarkPositions[18].x, ar_session_handler.leftHandLandmarkPositions[18].y, ar_session_handler.leftHandLandmarkPositions[18].z };
                input_->DeviceState_SetBoneValue(state, 18, UnityXRBone {.parentBoneIndex = 17, .position = position18, .rotation = {0, 0, 0, 1}});
                // pinky 2
                UnityXRVector3 position19 = { ar_session_handler.leftHandLandmarkPositions[19].x, ar_session_handler.leftHandLandmarkPositions[19].y, ar_session_handler.leftHandLandmarkPositions[19].z };
                input_->DeviceState_SetBoneValue(state, 19, UnityXRBone {.parentBoneIndex = 18, .position = position19, .rotation = {0, 0, 0, 1}});
                // pinky end
                UnityXRVector3 position20 = { ar_session_handler.leftHandLandmarkPositions[20].x, ar_session_handler.leftHandLandmarkPositions[20].y, ar_session_handler.leftHandLandmarkPositions[20].z };
                ...
                input_->DeviceState_SetBinaryValue(state, feature_index++, ar_session_handler.isLeftHandTracked);
            ...
            case kDeviceIdHoloKitHandRight: {
                ...
                if([ar_session_handler.rightHandLandmarkPositions count] != 21){
                    //std::cout << "landmark zero... which means no landmark has been detected yet" << std::endl;
                    break;
                }
                ...
                // wrist
                UnityXRVector3 position = { ar_session_handler.rightHandLandmarkPositions[0].x, ar_session_handler.rightHandLandmarkPositions[0].y, ar_session_handler.rightHandLandmarkPositions[0].z };
                ...
                // thumb start
                position = { ar_session_handler.rightHandLandmarkPositions[1].x, ar_session_handler.rightHandLandmarkPositions[1].y, ar_session_handler.rightHandLandmarkPositions[1].z };
                input_->DeviceState_SetBoneValue(state, 1, UnityXRBone {.parentBoneIndex = 0, .position = position, .rotation = {0, 0, 0, 1}});
                // thumb 1
                position = { ar_session_handler.rightHandLandmarkPositions[2].x, ar_session_handler.rightHandLandmarkPositions[2].y, ar_session_handler.rightHandLandmarkPositions[2].z };
                input_->DeviceState_SetBoneValue(state, 2, UnityXRBone {.parentBoneIndex = 1, .position = position, .rotation = {0, 0, 0, 1}});
                // thumb 2
                position = { ar_session_handler.rightHandLandmarkPositions[3].x, ar_session_handler.rightHandLandmarkPositions[3].y, ar_session_handler.rightHandLandmarkPositions[3].z };
                input_->DeviceState_SetBoneValue(state, 3, UnityXRBone {.parentBoneIndex = 2, .position = position, .rotation = {0, 0, 0, 1}});
                // thumb end
                position = { ar_session_handler.rightHandLandmarkPositions[4].x, ar_session_handler.rightHandLandmarkPositions[4].y, ar_session_handler.rightHandLandmarkPositions[4].z };
                input_->DeviceState_SetBoneValue(state, 4, UnityXRBone {.parentBoneIndex = 3, .position = position, .rotation = {0, 0, 0, 1}});
                // index start
                position = { ar_session_handler.rightHandLandmarkPositions[5].x, ar_session_handler.rightHandLandmarkPositions[5].y, ar_session_handler.rightHandLandmarkPositions[5].z };
                input_->DeviceState_SetBoneValue(state, 5, UnityXRBone {.parentBoneIndex = 0, .position = position, .rotation = {0, 0, 0, 1}});
                // index 1
                position = { ar_session_handler.rightHandLandmarkPositions[6].x, ar_session_handler.rightHandLandmarkPositions[6].y, ar_session_handler.rightHandLandmarkPositions[6].z };
                input_->DeviceState_SetBoneValue(state, 6, UnityXRBone {.parentBoneIndex = 5, .position = position, .rotation = {0, 0, 0, 1}});
                // index 2
                position = { ar_session_handler.rightHandLandmarkPositions[7].x, ar_session_handler.rightHandLandmarkPositions[7].y, ar_session_handler.rightHandLandmarkPositions[7].z };
                input_->DeviceState_SetBoneValue(state, 7, UnityXRBone {.parentBoneIndex = 6, .position = position, .rotation = {0, 0, 0, 1}});
                // index end
                position = { ar_session_handler.rightHandLandmarkPositions[8].x, ar_session_handler.rightHandLandmarkPositions[8].y, ar_session_handler.rightHandLandmarkPositions[8].z };
                input_->DeviceState_SetBoneValue(state, 8, UnityXRBone {.parentBoneIndex = 7, .position = position, .rotation = {0, 0, 0, 1}});
                // middle start
                position = { ar_session_handler.rightHandLandmarkPositions[9].x, ar_session_handler.rightHandLandmarkPositions[9].y, ar_session_handler.rightHandLandmarkPositions[9].z };
                input_->DeviceState_SetBoneValue(state, 9, UnityXRBone {.parentBoneIndex = 0, .position = position, .rotation = {0, 0, 0, 1}});
                // middle 1
                position = { ar_session_handler.rightHandLandmarkPositions[10].x, ar_session_handler.rightHandLandmarkPositions[10].y, ar_session_handler.rightHandLandmarkPositions[10].z };
                input_->DeviceState_SetBoneValue(state, 10, UnityXRBone {.parentBoneIndex = 9, .position = position, .rotation = {0, 0, 0, 1}});
                // middle 2
                position = { ar_session_handler.rightHandLandmarkPositions[11].x, ar_session_handler.rightHandLandmarkPositions[11].y, ar_session_handler.rightHandLandmarkPositions[11].z };
                input_->DeviceState_SetBoneValue(state, 11, UnityXRBone {.parentBoneIndex = 10, .position = position, .rotation = {0, 0, 0, 1}});
                // middle end
                position = { ar_session_handler.rightHandLandmarkPositions[12].x, ar_session_handler.rightHandLandmarkPositions[12].y, ar_session_handler.rightHandLandmarkPositions[12].z };
                input_->DeviceState_SetBoneValue(state, 12, UnityXRBone {.parentBoneIndex = 11, .position = position, .rotation = {0, 0, 0, 1}});
                // ring start
                position = { ar_session_handler.rightHandLandmarkPositions[13].x, ar_session_handler.rightHandLandmarkPositions[13].y, ar_session_handler.rightHandLandmarkPositions[13].z };
                input_->DeviceState_SetBoneValue(state, 13, UnityXRBone {.parentBoneIndex = 0, .position = position, .rotation = {0, 0, 0, 1}});
                // ring 1
                position = { ar_session_handler.rightHandLandmarkPositions[14].x, ar_session_handler.rightHandLandmarkPositions[14].y, ar_session_handler.rightHandLandmarkPositions[14].z };
                input_->DeviceState_SetBoneValue(state, 14, UnityXRBone {.parentBoneIndex = 13, .position = position, .rotation = {0, 0, 0, 1}});
                // ring 2
                position = { ar_session_handler.rightHandLandmarkPositions[15].x, ar_session_handler.rightHandLandmarkPositions[15].y, ar_session_handler.rightHandLandmarkPositions[15].z };
                input_->DeviceState_SetBoneValue(state, 15, UnityXRBone {.parentBoneIndex = 14, .position = position, .rotation = {0, 0, 0, 1}});
                // ring end
                position = { ar_session_handler.rightHandLandmarkPositions[16].x, ar_session_handler.rightHandLandmarkPositions[16].y, ar_session_handler.rightHandLandmarkPositions[16].z };
                input_->DeviceState_SetBoneValue(state, 16, UnityXRBone {.parentBoneIndex = 15, .position = position, .rotation = {0, 0, 0, 1}});
                // pinky start
                position = { ar_session_handler.rightHandLandmarkPositions[17].x, ar_session_handler.rightHandLandmarkPositions[17].y, ar_session_handler.rightHandLandmarkPositions[17].z };
                input_->DeviceState_SetBoneValue(state, 17, UnityXRBone {.parentBoneIndex = 0, .position = position, .rotation = {0, 0, 0, 1}});
                // pinky 1
                position = { ar_session_handler.rightHandLandmarkPositions[18].x, ar_session_handler.rightHandLandmarkPositions[18].y, ar_session_handler.rightHandLandmarkPositions[18].z };
                input_->DeviceState_SetBoneValue(state, 18, UnityXRBone {.parentBoneIndex = 17, .position = position, .rotation = {0, 0, 0, 1}});
                // pinky 2
                position = { ar_session_handler.rightHandLandmarkPositions[19].x, ar_session_handler.rightHandLandmarkPositions[19].y, ar_session_handler.rightHandLandmarkPositions[19].z };
                input_->DeviceState_SetBoneValue(state, 19, UnityXRBone {.parentBoneIndex = 18, .position = position, .rotation = {0, 0, 0, 1}});
                // pinky end
                position = { ar_session_handler.rightHandLandmarkPositions[20].x, ar_session_handler.rightHandLandmarkPositions[20].y, ar_session_handler.rightHandLandmarkPositions[20].z };
                ...
                input_->DeviceState_SetBinaryValue(state, feature_index++, ar_session_handler.isRightHandTracked);
                break;
            }
            default:
                return kUnitySubsystemErrorCodeFailure;
