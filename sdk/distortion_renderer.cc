...
void DistortionRenderer::SetMesh(const HoloKitMesh* mesh, HoloKitEye eye) {
...
void DistortionRenderer::RenderEyeToDisplay(
    ...
    const HoloKitEyeTextureDescription* left_eye,
    const HoloKitEyeTextureDescription* right_eye) const {
...
void DistortionRenderer::RenderDistortionMesh(
    const HoloKitEyeTextureDescription* eye_description,
    HoloKitEye eye) const {
  // glBindBuffer(GL_ARRAY_BUFFER, vertices_vbo_[eye]);
