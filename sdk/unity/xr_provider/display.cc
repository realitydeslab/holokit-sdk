...
UnitySubsystemErrorCode LoadDisplay(IUnityInterfaces* xr_interfaces) {
  ...
  HoloKitDisplayProvider::GetInstance().reset(
      new HoloKitDisplayProvider(trace, display));
  ...
  display_lifecycle_handler.Stop = [](UnitySubsystemHandle, void*) -> void {
      HoloKitDisplayProvider::GetInstance()->Stop();
  };
  display_lifecycle_handler.Shutdown = [](UnitySubsystemHandle, void*) -> void {
      HoloKitDisplayProvider::GetInstance()->Shutdown();
  };

  return HoloKitDisplayProvider::GetInstance()
      ->GetDisplay()
      ->RegisterLifecycleProvider("HoloKit", "HoloKit-Display",
