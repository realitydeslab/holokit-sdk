...
//    matrix_float4x4 offset;
//    offset.columns[3].x = -0.064;
//    offset.columns[3].y = 0;
//    offset.columns[3].z = 0;
//   // frame.camera.transform * offset
//
//    // HIGHLIGHT(amber): "frame.camera.transform is transpose of uniforms->viewMatrix"
//    [self print:@"viewMatrix" matrix: uniforms->viewMatrix];
//    [self print:@"transformMatrix" matrix: frame.camera.transform]; //in UIDeviceOrientationLandscapeRight
//    simd_float4x4 s = simd_mul(frame.camera.transform, uniforms->viewMatrix);
//    [self print:@"mul" matrix: s];
//
