    ...
    public class XRPackage : IXRPackage
    {
        ...
        private class PackageMetadata : IXRPackageMetadata
        {
         ...
         private static IXRPackageMetadata s_Metadata = new PackageMetadata(){
                packageName = "HoloKit SDK Display",
                packageId = "com.unity.xr.holokit.display",
                settingsType = typeof(HoloKitDisplayXRLoader).FullName,
                loaderMetadata = new List<IXRLoaderMetadata>() {
                    new LoaderMetadata() {
                        loaderName = "display",
                        loaderType = typeof(HoloKitDisplayXRLoader).FullName,
