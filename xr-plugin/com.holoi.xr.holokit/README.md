...
Use the following URL to install the latest version of the HoloKit SDK:

```
https://github.com/holoi/holokit-sdk.git?path=/xr-plugin/com.holoi.xr.holokit
```

or by directly adding the following line to the `Packages/manifest.json` file.

```
"com.holoi.xr.holokit": "https://github.com/holoi/holokit-sdk.git?path=/xr-plugin/com.holoi.xr.holokit"
```
