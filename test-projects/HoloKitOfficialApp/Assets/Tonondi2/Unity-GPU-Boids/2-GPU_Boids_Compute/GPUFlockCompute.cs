...
public struct GPUObstacle_Compute
{
...
public class GPUFlockCompute : MonoBehaviour {
    ...
    void Start()
    {
        ...
        // set obstacle buffer - haosizheng
    ...
    void Update()
    {
        ...
        //obstacles data:
        ComputeBuffer buffer2 = new ComputeBuffer(Obstacles.Length, 20);
        buffer2.SetData(obstaclesData);
        cshader.SetBuffer(this.kernelHandle, "obstacleBuffer", buffer2);
