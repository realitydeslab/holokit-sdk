...
namespace UnityEngine.Rendering.Universal
{
    internal partial class XRSystem
    {
        ...
        {
            UnityEngine.Debug.Log("<<<<<<<<<< URP: XRSystemInit()");
        ...
        {
            //UnityEngine.Debug.Log("<<<<<<<<<< URP: RenderMirrowView()");
            ...
            using (new ProfilingScope(cmd, _XRMirrorProfilingSampler))
            {
                ...
                //UnityEngine.Debug.Log("<<<<<<<<<< URP: before GetMirrorViewBlitDesc()");
                if (display.GetMirrorViewBlitDesc(null, out var blitDesc, mirrorBlitMode))
                {
                    //UnityEngine.Debug.Log("<<<<<<<<<< URP: after GetMirrorViewBlitDesc()");
                    if (blitDesc.nativeBlitAvailable)
                    {
                        //UnityEngine.Debug.Log("<<<<<<<<<< URP: native blit available");
                        display.AddGraphicsThreadMirrorViewBlit(cmd, blitDesc.nativeBlitInvalidStates, mirrorBlitMode);
                    }
                    else
                    {
                        //UnityEngine.Debug.Log("<<<<<<<<<< URP: native blit not available");
                ...
                {
                    //UnityEngine.Debug.Log("<<<<<<<<<< URP: QueryMirrorViewBlitDesc is nullptr");
