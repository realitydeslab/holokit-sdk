...
void UnityHoloKit_TurnOnHandTracking() {
    [[HandTrackingController sharedInstance] setIsHandTrackingOn:YES];
    NSLog(@"[hand_tracker] did turn on hand tracking");
}

void UnityHoloKit_TurnOffHandTracking() {
    [[HandTrackingController sharedInstance] setIsHandTrackingOn:NO];
    NSLog(@"[hand_tracker] did turn off hand tracking");
}

bool UnityHoloKit_IsHandTrackingOn(){
    return [[HandTrackingController sharedInstance] isHandTrackingOn];
}
